...
object ValidUserAnswersForSubmission {
  ...
  val userAnswersForOrganisation = UserAnswers("id")
    ...
    .set(ReporterOrganisationAddressPage, 0, validAddress).success.value
    ...
    .set(AssociatedEnterpriseLoopPage, 0, validEnterprises).success.value
  ...
  val userAnswersForIndividual = UserAnswers("id")
    ...
    .set(ReporterIndividualAddressPage, 0, validAddress).success.value
  ...
  val userAnswersModelsForOrganisation = UserAnswers("id")
    .setBase(UnsubmittedDisclosurePage, Seq(UnsubmittedDisclosure("1", "My First"))).success.value
    .set(DisclosureDetailsPage, 0, validDisclosureDetails).success.value
    .set(ReporterDetailsPage, 0, reporterDetailsAsOrganisation).success.value
    .set(AssociatedEnterpriseLoopPage, 0, validEnterprises).success.value
    .set(TaxpayerLoopPage, 0, validTaxpayers).success.value
    .set(IntermediaryLoopPage, 0, validIntermediaries).success.value
    .set(AffectedLoopPage, 0, validAffectedPersons).success.value
    .set(HallmarkDetailsPage, 0, validHallmarkDetails).success.value
    .set(ArrangementDetailsPage, 0, validArrangementDetails).success.value
}
