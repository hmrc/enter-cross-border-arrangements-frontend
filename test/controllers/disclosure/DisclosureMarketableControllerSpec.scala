...
class DisclosureMarketableControllerSpec extends SpecBase with MockServiceApp with NunjucksSupport with JsonMatchers {
  ...
  "DisclosureMarketable Controller" - {
    ...
    "must return OK and the correct view for a GET" in {
      ...
      templateCaptor.getValue mustEqual "disclosure/disclosureMarketable.njk"
    ...
    "must redirect to the next page when valid data is submitted" in {
      ...
      val request =
        FakeRequest(POST, disclosureMarketableRoute)
