      ...
      "with an INTERMEDIARY role of type PROMOTER & EXEMPT from a country" in {
        ...
        verifyList(userAnswers) {
          rows =>
            ...
            rows.contains(
              """{"key":{"text":"Address","classes":"govuk-!-width-one-half"},"value":{"html":"\n        addressLine 1<br>\n        addressLine 2<br>\n        addressLine 3<br>\n        addressLine 4<br>\n        town<br>\n        county<br>\n        postcode\n     "}"""
            ) mustBe true
            rows.contains(
              """{"key":{"text":"Do you want to provide an additional email address?","classes":"govuk-!-width-one-half"},"value":{"text":"Yes"}"""
            ) mustBe true
            ...
            rows.contains(
              """{"key":{"text":"Reason for reporting in the UK","classes":"govuk-!-width-one-half"},"value":{"text":"You are tax resident in the UK"}"""
            ) mustBe true
      ...
      "with a TAXPAYER role & arrangement is MARKETABLE" in {
        ...
        verifyList(userAnswers) {
          rows =>
            ...
            rows.contains(
              """{"key":{"text":"Tax identification numbers for FRANCE","classes":"govuk-!-width-one-half"},"value":{"text":"TIN123123, TIN123123, TIN123123"}}"""
            ) mustBe true
            ...
            rows.contains(
              """{"key":{"text":"Why are you reporting as a taxpayer?","classes":"govuk-!-width-one-half"},"value":{"text":"There are no intermediaries involved"}"""
            ) mustBe true
