...
class ReporterTinUKQuestionController @Inject()(
  ...
  private def redirect(checkRoute: CheckRoute, value: Option[Boolean], index: Int = 0): Call =
    navigator.routeMap(ReporterTinUKQuestionPage)(checkRoute)(value)(index)
    ...
    implicit request =>
      ...
      form.bindFromRequest().fold(
        ...
        value => {
          ...
          for {
            updatedAnswers <- Future.fromTry(request.userAnswers.set(ReporterTinUKQuestionPage, value))
