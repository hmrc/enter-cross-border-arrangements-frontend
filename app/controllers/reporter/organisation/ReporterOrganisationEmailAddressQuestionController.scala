...
class ReporterOrganisationEmailAddressQuestionController @Inject()(
    ...
    formProvider: ReporterOrganisationEmailAddressQuestionFormProvider,
    ...
    implicit request =>
      ...
      form.bindFromRequest().fold(
        ...
        value =>
          ...
          } yield Redirect(navigator.nextPage(ReporterOrganisationEmailAddressQuestionPage, mode, updatedAnswers))
      )
  }
}
