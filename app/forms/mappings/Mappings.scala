...
trait Mappings extends Formatters with Constraints {
  ...
  protected def validatedDisclosureIDsText(requiredKey: String, invalidKey: String, countryList: Seq[Country], regex: String): FieldMapping[String] =
    of(validatedDisclosureIDs(requiredKey, invalidKey, countryList, regex))
}
