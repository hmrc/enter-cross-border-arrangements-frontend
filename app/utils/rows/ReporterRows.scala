...
import pages.reporter.organisation.{
...
trait ReporterRows extends RowBuilder {
  ...
  def roleInArrangementPage(id: Int): Option[Row] = userAnswers.get(RoleInArrangementPage, id) map {
    answer =>
      toRow(
  ...
  def reporterOrganisationName(id: Int): Option[Row] = userAnswers.get(ReporterOrganisationNamePage, id) map {
    answer =>
      toRow(
  ...
  def reporterIndividualName(id: Int): Option[Row] = userAnswers.get(ReporterIndividualNamePage, id) map {
    answer =>
      toRow(
  ...
  def reporterIndividualPlaceOfBirth(id: Int): Option[Row] = userAnswers.get(ReporterIndividualPlaceOfBirthPage, id) map {
    answer =>
      toRow(
  ...
  def reporterIndividualDateOfBirth(id: Int): Option[Row] = userAnswers.get(ReporterIndividualDateOfBirthPage, id) map {
    answer =>
      toRow(
  ...
  def intermediaryWhyReportInUKPage(id: Int): Option[Row] = userAnswers.get(IntermediaryWhyReportInUKPage, id) map {
    answer =>
      toRow(
  ...
  def intermediaryRolePage(id: Int): Option[Row] = userAnswers.get(IntermediaryRolePage, id) map {
    answer =>
      toRow(
  ...
  def buildExemptCountriesSummary(id: Int): Seq[Row] =
    (userAnswers.get(IntermediaryExemptionInEUPage, id), userAnswers.get(IntermediaryDoYouKnowExemptionsPage, id)) match {
      case (Some(YesNoDoNotKnowRadios.Yes), Some(true)) =>
        Seq(intermediaryExemptionInEUPage(YesNoDoNotKnowRadios.Yes, id), intermediaryDoYouKnowExemptionsPage(true, id)) ++ intermediaryWhichCountriesExemptPage(
          id
        ).toSeq
