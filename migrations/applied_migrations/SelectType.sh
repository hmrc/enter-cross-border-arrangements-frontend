...
echo "selectType.title = selectType" >> ../conf/messages.en
echo "selectType.heading = selectType" >> ../conf/messages.en
echo "selectType.organisation = Organisation" >> ../conf/messages.en
echo "selectType.individual = Individual" >> ../conf/messages.en
echo "selectType.checkYourAnswersLabel = selectType" >> ../conf/messages.en
